...
public final class GameResources {
	...
	public String getGameWonStatus() {
		...
		if (gameWonStatus) {
			endOfGameMessage.append("GAME OVER");
		} else {
	...
	public void registerCallbacks() {
		...
		ccHandler.registerRequestCallback(ActionData.SYNC_GAME_BOARD_DATA, (message) -> {
			...
			Platform.runLater(new Runnable() {
				...
				public void run() {
					// Get the data
					SyncGameBoardDataRequestData data = SyncGameBoardDataRequestData.class
							.cast(message.getActionData());
					// Sync the data
					food = data.getFood();
					fuel = data.getFuel();
					day = data.getDay();
