...
public class Location {
	...
	public enum LocationType {
		CONTROL_ROOM("control_room"), MED_BAY("med_bay"), MESS_HALL("mess_hall"), RESIDENTAIL("residential"), ARMORY(
				"armory"), LIBRARY("library"), VEHICLE_BAY("vehicle_bay"), ENGINE_ROOM("engine_room");
	...
	public enum LocationTier {
		TIER_0(0, 0, 2), TIER_1(1, 3, 4), TIER_2(2, 5, 6), TIER_3(3, 7, 10);
	...
	public static void initVisitedLocations(Collection<Location> locations) {
		for (Location loc : locations) {
			if (loc.getType() != LocationType.CONTROL_ROOM) {
