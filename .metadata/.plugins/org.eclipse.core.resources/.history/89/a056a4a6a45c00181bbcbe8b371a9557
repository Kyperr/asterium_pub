...
public class Book extends AbstractLocationItem {
	...
	// ===== CONSTRUCTORS =====
	/**
	 * Construct a book with a random name which boosts defined stats by DEFAULT_STAT_BOOST.
	 * 
	 * @param stats The {@link Stat}s which this book will boost.
	 */
	...
	/**
	 * Construct a book with a random name and random stats which boosts stats by a defined amount.
	 * 
	 * @param amount The amount by which this book will boost stats.
	 */
	...
	/**
	 * Construct a book with a random name which boosts defined stats by a defined amount.
	 * 
	 * @param stats The {@link Stat}s which this book will boost.
	 * @param amount The amount by which this book will boost stats.
	 */
	...
	@Override
	/**
	 * Give user a permanent AffectStats status effect that boosts their stats by amount.
	 */
	public void applyEffect(GameState state, PlayerCharacter user, Collection<PlayerCharacter> targets) {
		user.addStatusEffect(new AffectStats(user, "Read " + this.getName(),
											 this.stats, this.effect));
	}
	// ===================
